...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-lg"><b>ATT - </b>GROUP system</span>
      <p>system</p>
    </a>
...
<li class="header">MASTER</li>
      ...
      <li><a href="<?php echo base_url();?>C_department"><i class="fa fa-sitemap"></i> Department</a></li>
     <li><a href="<?php echo base_url();?>C_topic"><i class="fa fa-comments"></i> Topic</a></li>
    <li><a href="<?php echo base_url();?>C_topic"><i class="fa fa-clone"></i> Module download</a></li>
 ...
 <li> <a href="<?php echo base_url();?>transaction/soa"> <i class="icon-double-angle-right"></i> </i><i class="fa fa-calendar-check-o bigger-120"></i> SOA</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i><?php echo isset($title)?$title:'';?>
      </h1>
      <ol class="breadcrumb">
...
<!-- END OF BOX CONTENT  -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016-2017 <a href="http://att-group.co.id" target="new">ATT-Group Company</a>.</strong> All rights
    reserved.
  </footer>
