...
function add_jabatan()
    {
      ...
      $('.modal-title3').text('Add jabatan'); // Set Title to Bootstrap modal title
    }
        ...
        <form action="#" id="form3" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="nama_jabatan" type="text" class="form-control nama" id="nama_jabatan" placeholder="Name" value="" />
              </div>
            </div>
            <div class="form-group">
