      ...
      <div class="row">
        ...
        <div class="col-md-8">
                ...
                <div class="post clearfix">
                  <form class="form-horizontal" method="post" action="<?php echo base_url();?>home_karyawan/update_profile_setting" enctype="multipart/form-data">
...
<div class="col-md-8">
<input name="nama" class="form-control" type="text" id="nama" value="<?php echo $row->nama;?>">
<span class="col-sm-11">
<input name="idkarya" type="hidden" id="idkarya" value="<?php echo $this->session->userdata('usrkarya');?>" />
...
<div class="col-md-8">
<input name="nik" class="form-control" type="text" id="nik" value="<?php echo $row->nik;?>" disabled="disabled">
</div>
</div>
