...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 05, 2016 at 07:18 PM
...
(41, 313, 414, 'hiiiiiiii', NULL, '2016-10-06 02:12:13', 'N'),
(42, 616, 212, 'haiiiiiiiiiiiiiii', NULL, '2016-10-06 02:16:15', 'N'),
(43, 212, 616, 'iyaaaaaaaaaaaaaaa', NULL, '2016-10-06 02:17:23', 'N');
...
--
ALTER TABLE `diskusi_detail`
  MODIFY `id_diskusi_detail` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
...
--
ALTER TABLE `pesan`
  MODIFY `id_pesan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
